...
## Deployment
Deployed on AWS using App Runner, RDS PostgreSQL, CloudFront CDN, and ECR.
See internal deployment documentation or the AWS Console for infrastructure details.
