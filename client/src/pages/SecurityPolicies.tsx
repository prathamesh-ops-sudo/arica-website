  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach(particle => {
        ...
        ctx.fillStyle = `rgba(61, 112, 183, ${particle.alpha * (0.5 + Math.sin(time * 3 + particle.angle) * 0.5)})`;
        ctx.fill();
      });
      ...
      for (let i = 0; i < 3; i++) {
        ...
        ctx.strokeStyle = `rgba(61, 112, 183, ${0.1 - i * 0.03})`;
  ...
  return (
    <div className="relative" data-testid="compliance-meter">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <span className="text-4xl font-bold text-[#3D70B7]" data-testid="text-compliance-value">
          {animatedValue}%
        </span>
    ...
    <div className="p-6 rounded-3xl bg-black/40 backdrop-blur-xl border border-white/10" data-testid="policy-builder">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-2 rounded-lg bg-[#3D70B7]/20">
          <Sparkles className="w-5 h-5 text-[#3D70B7]" />
        </div>
        <div>
        ...
        {blocks.map((block) => (
          <motion.div
            ...
            className={`
              ...
              ${selectedBlock === block.id 
                ? 'ring-2 ring-[#3D70B7] bg-[#3D70B7]/20' 
          ...
          >
            ...
            {block.connected.length > 0 && (
              <div className="absolute -top-2 -right-2 w-5 h-5 rounded-full bg-[#3D70B7] flex items-center justify-center">
            ...
            <AnimatePresence>
              {selectedBlock === block.id && (
                <motion.div
                  ...
                  animate={{ scale: 1 }}
                  exit={{ scale: 0 }}
                  className="absolute -top-1 -left-1 w-3 h-3 rounded-full bg-[#3D70B7]"
                />
              )}
            </AnimatePresence>
          </motion.div>
      ...
      {connections.length > 0 && (
        <motion.div 
          ...
          className="mt-6 p-4 rounded-xl bg-[#3D70B7]/10 border border-[#3D70B7]/30"
        >
          <div className="flex items-center gap-2 mb-2">
            <CheckCircle className="w-4 h-4 text-[#3D70B7]" />
      ...
      <div className="relative z-content">
        ...
        <div className="container mx-auto px-6 py-24">
          ...
          <motion.div
            ...
            className="mb-12 p-6 rounded-3xl bg-black/40 backdrop-blur-xl border border-[#3D70B7]/30"
          >
            ...
            {isMobile && (
              <motion.div 
                initial={{ opacity: 0, y: -10 }}
                animate={{ opacity: 1, y: 0 }}
                className="mb-4 p-3 rounded-xl bg-[#3D70B7]/10 border border-[#3D70B7]/30 text-sm"
              >
                <div className="flex items-center gap-2">
                  <Info className="w-4 h-4 text-[#3D70B7]" />
                ...
                <motion.div
                  ...
                  className={`
                    ...
                    ${selectedPolicy === category.id 
                      ? 'border-[#3D70B7] ring-2 ring-[#3D70B7]/50' 
                          ...
                          <ul className="space-y-1">
                            {category.requirements.map((req, i) => (
                              <li key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                                <CheckCircle className="w-3 h-3 text-[#3D70B7]" />
                                {req}
                              </li>
                            ))}
                          </ul>
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <Link
                href="/contact"
                className="px-6 py-3 rounded-full bg-[#3D70B7] text-black font-medium hover:bg-[#3D70B7]/90 transition-colors flex items-center gap-2"
