...
export default function SecurityPolicies() {
  ...
  return (
    <div className="min-h-screen aurora-bg text-white relative overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-br from-[#00D4FF]/5 via-transparent to-cyan-500/5" />
      </div>
        ...
        <div className="container mx-auto px-6 py-24">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Security
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#00D4FF] to-cyan-500">
                Policies
              </span>
            </h1>
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl bg-gradient-to-r from-[#00D4FF]/10 to-cyan-500/10 border border-[#00D4FF]/30"
          >
