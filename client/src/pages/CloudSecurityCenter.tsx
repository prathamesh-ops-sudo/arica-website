...
function CircularProgress({ value, size = 80, strokeWidth = 6, color = '#3D70B7', label, sublabel }: {
  value: number;
  size?: number;
  strokeWidth?: number;
  color?: string;
    ...
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      <div 
        ...
        style={{
          ...
          background: `radial-gradient(ellipse at 50% 30%, rgba(61, 112, 183, 0.05) 0%, transparent 60%),
                       radial-gradient(ellipse at 20% 70%, rgba(28, 44, 90, 0.04) 0%, transparent 50%)`,
        }}
      />
      <style>{`
        @keyframes gridMove {
      ...
      {Array.from({ length: 30 }).map((_, i) => (
        <div
          ...
          style={{
            ...
            backgroundColor: i % 3 === 0 ? '#3D70B7' : '#3D70B7',
      ...
      <div
        className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#3D70B7]/30 to-transparent"
        style={{
      ...
      <div className="relative">
        ...
        <AnimatePresence>
          {isHovered && (
            ...
            >
              <div 
                className="bg-[#000510]/95 border border-[#3D70B7]/50 rounded-xl p-3 whitespace-nowrap font-mono backdrop-blur-xl"
                style={{ 
                  boxShadow: '0 0 20px rgba(61, 112, 183, 0.2)',
                  minWidth: '180px'
                }}
              >
                <div className="text-[#3D70B7] font-bold text-sm mb-1">{region.name}</div>
  ...
  return (
    ...
    >
      <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-transparent via-current to-transparent opacity-50" 
        style={{ color: event.type === 'threat' ? '#ef4444' : event.type === 'warning' ? '#eab308' : '#3D70B7' }} 
      />
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      const newPacket: DataPacket = {
        ...
        progress: 0,
        color: Math.random() > 0.7 ? '#3D70B7' : '#3D70B7',
      };
          ...
          <div className="container mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center gap-4 font-mono text-xs">
                <motion.div 
                  className="flex items-center gap-2 text-[#3D70B7]"
                  animate={{ scale: [1, 1.05, 1] }}
                  transition={{ duration: 2, repeat: Infinity }}
                >
                  <Server className="w-3 h-3" />
                  <span className="text-white">{animatedMetrics.resources}</span>
                  <span className="text-[#3D70B7]/70">resources</span>
                </motion.div>
                <motion.div 
                ...
                >
                  ...
                  <span className="text-[#3D70B7]/70">threats</span>
                </motion.div>
              </div>
        ...
        <main className="pt-20 pb-12">
          ...
          >
            ...
            >
              ...
              <span className="text-[#3D70B7]">CLOUD SECURITY COMMAND CENTER</span>
            </motion.div>

            <h1 className="font-mono text-3xl md:text-5xl font-bold mb-3">
              <span className="text-[#3D70B7]">Cloud </span>
              <span className="text-white">Infrastructure</span>
              <span className="text-[#3D70B7]"> Security</span>
            </h1>
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <Interactive3DCard 
                className="bg-gradient-to-br from-[#3D70B7]/20 to-[#3D70B7]/5 backdrop-blur-sm border border-[#3D70B7]/40 rounded-2xl p-4 relative overflow-hidden group hover:border-[#3D70B7] cursor-pointer" 
                dataTestId="metric-card-resources"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#3D70B7]/10 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
                <div className="relative">
                  <div className="flex items-center gap-2 mb-2">
                    <motion.div animate={{ rotate: 360 }} transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}>
                      <Server className="w-5 h-5 text-[#3D70B7]" />
                    </motion.div>
                    <span className="font-mono text-xs text-[#3D70B7]/70 uppercase">Total Resources</span>
                  </div>
                  <div className="text-3xl font-bold font-mono text-white">{animatedMetrics.resources}</div>
                  <div className="text-xs text-[#3D70B7]/50 mt-1 flex items-center gap-1">
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-center gap-2 mb-2">
                    <Globe2 className="w-5 h-5 text-[#3D70B7]" />
                    <span className="font-mono text-xs text-[#3D70B7]/70 uppercase">Active Regions</span>
                  </div>
                  <div className="text-3xl font-bold font-mono text-[#3D70B7]">{filteredRegions.length}</div>
                  <div className="text-xs text-[#3D70B7]/50 mt-1">Across {selectedProvider === 'all' ? '3 providers' : selectedProvider.toUpperCase()}</div>
                </div>
              </Interactive3DCard>
            </div>
          </motion.div>
          ...
          >
            <div className="flex flex-wrap items-center justify-center gap-3">
              {(['all', 'aws', 'azure', 'gcp'] as const).map((provider) => {
                ...
                const colors = {
                  all: { active: 'bg-[#3D70B7] text-[#000510]', inactive: 'bg-[#3D70B7]/10 text-[#3D70B7] border-[#3D70B7]/30 hover:bg-[#3D70B7]/20' },
          ...
          >
            <div 
              className="relative rounded-2xl overflow-hidden border border-[#3D70B7]/30 bg-[#000510]/80 backdrop-blur-sm"
              style={{ height: '350px' }}
            ...
            >
                ...
                <svg width="100%" height="100%" viewBox="0 0 100 80">
                  <defs>
                    ...
                    <linearGradient id="lineGrad" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="#3D70B7" stopOpacity="0" />
                      <stop offset="50%" stopColor="#3D70B7" stopOpacity="0.5" />
                      <stop offset="100%" stopColor="#3D70B7" stopOpacity="0" />
                    </linearGradient>
                  </defs>
              ...
              <div className="absolute top-3 right-3 flex items-center gap-2">
                <div className="bg-black/50 backdrop-blur-sm rounded-lg px-3 py-2 border border-[#3D70B7]/20">
                  <div className="flex items-center gap-2">
                    <Activity className="w-3 h-3 text-[#3D70B7]" />
                    <span className="text-[10px] text-white/60 font-mono">DATA FLOW</span>
                    <motion.div 
                      className="w-1.5 h-1.5 rounded-full bg-[#3D70B7]"
              ...
              <div className="absolute bottom-3 right-3 font-mono text-[10px] text-[#3D70B7]/50">
                <div className="flex items-center gap-2">
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
              <motion.div
                ...
                className="bg-[#000510]/80 backdrop-blur-sm border border-[#3D70B7]/30 rounded-2xl p-5"
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 rounded-lg bg-[#3D70B7]/10">
                    <Key className="w-5 h-5 text-[#3D70B7]" />
                  </div>
                  <div>
                    <h3 className="font-mono font-bold text-white">IAM Policy Assessment</h3>
                    <p className="text-xs text-[#3D70B7]/60">Risk score analysis</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {iamPolicies.map((policy) => (
                    ...
                    >
                      <motion.div
                        className="p-3 rounded-lg bg-white/5 border border-white/10 hover:border-[#3D70B7]/30 transition-all"
                        layout
                      >
                          ...
                          {expandedCard === policy.id && (
                            ...
                            >
                              ...
                              <div className="flex justify-between text-[10px]">
                                ...
                                <button className="text-[#3D70B7] hover:text-[#3D70B7]/80">View Details →</button>
                              </div>
                            </motion.div>
                          )}
                        </AnimatePresence>
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 rounded-lg bg-[#3D70B7]/10">
                    <Container className="w-5 h-5 text-[#3D70B7]" />
                  </div>
                  <div>
                    <h3 className="font-mono font-bold text-white">Container Security</h3>
                    <p className="text-xs text-[#3D70B7]/60">{animatedMetrics.containers} running</p>
                  </div>
                </div>
                  ...
                  {containers.map((container) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="text-[10px] text-[#3D70B7]/50 font-mono">{container.image}</div>
                                ...
                                <div>
                                  ...
                                  <div className="h-1.5 bg-white/10 rounded-full overflow-hidden">
                                    <motion.div
                                      ...
                                      className="h-full bg-[#3D70B7] rounded-full"
                                    />
                                  </div>
                                  <div className="text-[10px] text-[#3D70B7] mt-0.5">{container.cpu}%</div>
                                </div>
                                <div>
                                  ...
                                  <div className="text-[10px] text-[#3D70B7] mt-0.5">{container.memory}%</div>
                                </div>
                              </div>
                            </motion.div>
                          )}
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 rounded-lg bg-[#3D70B7]/10">
                    <FileCheck className="w-5 h-5 text-[#3D70B7]" />
                  </div>
                  <div>
                    <h3 className="font-mono font-bold text-white">Configuration Checklist</h3>
                    <p className="text-xs text-[#3D70B7]/60">Cloud hardening status</p>
                  </div>
                </div>

                <div className="space-y-2 max-h-[300px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-[#3D70B7]/20 scrollbar-track-transparent">
                  {configChecks.map((check, index) => (
                    <motion.div
                      ...
                      className="flex items-center justify-between p-2 rounded-lg bg-white/5 border border-white/10 hover:border-[#3D70B7]/30 transition-all"
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`w-10 h-5 rounded-full transition-all flex-shrink-0 ml-2 relative ${
                          check.enabled ? 'bg-[#3D70B7]' : 'bg-white/20'
                        }`}
              ...
              >
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-mono text-sm text-[#3D70B7]/70">Risk Score</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    <Lock className="w-5 h-5 text-[#3D70B7]" />
                    <span className="font-mono text-sm text-[#3D70B7]/70">Policies</span>
                  </div>
                  <div className="text-4xl font-bold font-mono text-[#3D70B7]">
                    {iamPolicies.filter(p => p.status === 'compliant').length}/{iamPolicies.length}
                  </div>
                  <div className="text-xs text-[#3D70B7]/50 mt-1">compliant</div>
                </Interactive3DCard>
              </motion.div>
            </div>
            ...
            <motion.div
              ...
              className="bg-gradient-to-r from-[#3D70B7]/5 via-[#3D70B7]/10 to-[#3D70B7]/5 border border-[#3D70B7]/30 rounded-2xl p-8 relative overflow-hidden"
            >
              ...
              <div className="max-w-3xl mx-auto text-center relative">
                <div className="flex items-center justify-center gap-3 mb-4">
                  ...
                  >
                    <Shield className="w-8 h-8 text-[#3D70B7]" />
                  </motion.div>
                ...
                <p className="text-[#3D70B7]/70 font-mono text-sm mb-6">
                ...
                <div className="grid grid-cols-3 gap-4 mb-6 font-mono text-center">
                  <Interactive3DCard className="bg-[#000510]/60 rounded-lg p-3 border border-[#3D70B7]/20">
                    <motion.div 
                      className="text-2xl font-bold text-[#3D70B7]"
                      animate={{ scale: [1, 1.05, 1] }}
                      transition={{ duration: 2, repeat: Infinity }}
                    >
                      200+
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center gap-2 bg-[#3D70B7] text-[#000510] font-mono font-bold px-6 py-3 rounded-lg hover:bg-[#3D70B7]/90 transition-all hover:scale-105"
