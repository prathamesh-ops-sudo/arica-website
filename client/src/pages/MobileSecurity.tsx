  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-2xl">
      {[0, 1, 2].map((i) => (
        <motion.div
          key={i}
          className="absolute inset-0 border-2 border-[#9D4EDD] rounded-2xl"
  ...
  return (
    <div className="relative h-1 bg-white/10 rounded-full overflow-hidden">
      <motion.div
        ...
        style={{
          background: 'linear-gradient(90deg, #9D4EDD, #9944ff, #9D4EDD)',
...
export default function MobileSecurity() {
  ...
  return (
    <div className="min-h-screen text-white relative overflow-hidden" style={{ backgroundColor: '#000510' }}>
      <AmbientParticles variant="network" count={30} color="#9D4EDD" opacity={0.15} />
      
      <div 
        className="fixed inset-0 pointer-events-none z-0"
        style={{
          background: 'radial-gradient(ellipse at 30% 20%, rgba(157, 78, 221, 0.08) 0%, transparent 50%), radial-gradient(ellipse at 70% 80%, rgba(168, 85, 247, 0.05) 0%, transparent 40%)',
        }}
      />
      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-6 py-24">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border mb-6" style={{ backgroundColor: 'rgba(157, 78, 221, 0.1)', borderColor: 'rgba(157, 78, 221, 0.3)' }}>
              <Smartphone className="w-4 h-4" style={{ color: '#9D4EDD' }} />
              <span className="text-sm font-medium" style={{ color: '#9D4EDD' }}>Mobile Security Testing</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Mobile App
              <span className="block text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(to right, #9D4EDD, #a855f7)' }}>
                Security Assessment
              </span>
            </h1>
          ...
          >
            <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
              <Smartphone className="w-5 h-5" style={{ color: '#9D4EDD' }} />
              ...
              {devices.map((device) => (
                ...
                >
                  <AnimatePresence>
                    {selectedDevice?.id === device.id && (
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-br from-[#9D4EDD]/20 to-purple-500/10"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                  ...
                  {selectedDevice?.id === device.id && (
                    <motion.div
                      className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#9D4EDD] to-purple-500"
            ...
            <AnimatePresence mode="wait">
              {selectedDevice && (
                ...
                >
                  <motion.div 
                    className="p-4 rounded-xl bg-black/40 backdrop-blur-xl border border-[#9D4EDD]/30 relative overflow-hidden"
                  ...
                  >
                    ...
                    <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
                      <div className="flex items-center gap-4">
                        <motion.div 
                          className="p-3 rounded-lg bg-[#9D4EDD]/10"
                          animate={isScanning ? { 
                            boxShadow: ['0 0 0 rgba(157, 78, 221,0)', '0 0 20px rgba(157, 78, 221,0.5)', '0 0 0 rgba(157, 78, 221,0)']
                          } : {}}
                        ...
                        >
                          {selectedDevice.type === 'phone' ? (
                            ...
                            <Tablet className="w-6 h-6 text-[#9D4EDD]" />
                          )}
                        </motion.div>
                        <div>
                      ...
                      <motion.button
                        ...
                        style={{ backgroundImage: 'linear-gradient(to right, #9D4EDD, #a855f7)' }}
          ...
          <AnimatePresence>
            {isScanning && (
              ...
              >
                <div className="p-6 rounded-2xl bg-black/40 backdrop-blur-xl border border-[#9D4EDD]/30 relative overflow-hidden">
                  <ScanRippleEffect isActive={true} />
                  <div className="relative z-10">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="font-semibold flex items-center gap-2">
                        <motion.div 
                          className="w-3 h-3 rounded-full bg-[#9D4EDD]"
                          animate={{ 
                            scale: [1, 1.2, 1],
                            boxShadow: ['0 0 0 0 rgba(157, 78, 221,0.5)', '0 0 0 10px rgba(157, 78, 221,0)', '0 0 0 0 rgba(157, 78, 221,0)']
                          }}
                          transition={{ duration: 1.5, repeat: Infinity }}
                        />
                      ...
                      <div className="flex items-center gap-3">
                        <motion.span
                          ...
                          initial={{ scale: 1.2 }}
                          animate={{ scale: 1 }}
                          className="text-sm font-mono text-[#9D4EDD]"
                        >
                        ...
                        return (
                          <motion.div
                            ...
                            className={`p-3 rounded-lg text-center transition-all relative overflow-hidden ${
                              i === currentPhase
                                ? 'bg-[#9D4EDD]/20 border border-[#9D4EDD]/50 text-[#9D4EDD]'
                                : i < currentPhase
                                ? 'bg-green-500/20 border border-green-500/50 text-green-400'
                                : 'bg-white/5 border border-white/10 text-gray-500'
                            }`}
                            animate={i === currentPhase ? {
                              boxShadow: ['0 0 0 rgba(157, 78, 221,0)', '0 0 15px rgba(157, 78, 221,0.3)', '0 0 0 rgba(157, 78, 221,0)']
                            } : {}}
                          ...
                          >
                            ...
                            {i === currentPhase && (
                              <motion.div
                                className="absolute bottom-0 left-0 h-0.5 bg-[#9D4EDD]"
                                initial={{ width: '0%' }}
                                animate={{ width: '100%' }}
            ...
            {scanComplete && (
              ...
              >
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="flex flex-col md:flex-row items-center gap-8 p-6 rounded-2xl bg-black/40 backdrop-blur-xl border border-[#9D4EDD]/30"
                >
                ...
                >
                  <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
                    <FileWarning className="w-5 h-5" style={{ color: '#9D4EDD' }} />
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <motion.div 
                      className="flex items-center gap-2 px-4 py-2 rounded-lg bg-black/40 border border-[#9D4EDD]/30"
                      initial={{ scale: 0.9 }}
                      animate={{ scale: 1 }}
                    >
                ...
                >
                  <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
                    <Eye className="w-5 h-5" style={{ color: '#9D4EDD' }} />
                      ...
                      return (
                        <motion.button
                          ...
                          className={`p-4 rounded-xl border backdrop-blur-xl text-center transition-all relative overflow-hidden ${getRiskColor(perm.risk)} ${
                            selectedPermission?.id === perm.id ? 'ring-2 ring-[#9D4EDD]' : ''
                          }`}
                ...
                <motion.div
                  ...
                  className="mt-12 p-8 rounded-2xl bg-gradient-to-r from-[#9D4EDD]/10 to-purple-500/10 border border-[#9D4EDD]/30 text-center relative overflow-hidden"
                >
                  <motion.div
          ...
          {!selectedDevice && !isScanning && !scanComplete && (
            ...
            >
              <motion.div 
                className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#9D4EDD]/10 border border-[#9D4EDD]/30 mb-4"
                animate={{ 
                  boxShadow: ['0 0 0 0 rgba(157, 78, 221,0.3)', '0 0 0 20px rgba(157, 78, 221,0)', '0 0 0 0 rgba(157, 78, 221,0)']
                }}
                transition={{ duration: 2, repeat: Infinity }}
              >
                <Smartphone className="w-10 h-10 text-[#9D4EDD]" />
              </motion.div>
