  ...
  return (
    <div className="relative h-1 bg-white/10 rounded-full overflow-hidden">
      <motion.div
        ...
        style={{
          background: 'linear-gradient(90deg, #00D4FF, #9944ff, #00D4FF)',
              ...
              {devices.map((device) => (
                ...
                >
                  <AnimatePresence>
                    {selectedDevice?.id === device.id && (
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-br from-[#00D4FF]/20 to-purple-500/10"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                  ...
                  {selectedDevice?.id === device.id && (
                    <motion.div
                      className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#00D4FF] to-purple-500"
            ...
            {scanComplete && (
              ...
              >
                ...
                <motion.div
                  ...
                  className="mt-12 p-8 rounded-2xl bg-gradient-to-r from-[#00D4FF]/10 to-purple-500/10 border border-[#00D4FF]/30 text-center relative overflow-hidden"
                >
                  <motion.div
