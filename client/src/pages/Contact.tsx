          ...
          >
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-background/90 backdrop-blur-sm rounded-xl p-4 border border-[#3D70B7]/20">
              ...
              <div className="flex items-center gap-4 mt-2 text-xs text-muted-foreground">
                <a href="tel:+917091175596" className="hover:text-[#3D70B7] transition-colors">
                  +91 70911 75596
                </a>
                <a href="mailto:contact@aricatech.com" className="hover:text-[#3D70B7] transition-colors">
