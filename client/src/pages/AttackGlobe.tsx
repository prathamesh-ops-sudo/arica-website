...
export default function AttackGlobe() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a1e] relative overflow-hidden">
      <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl bg-[#0a0a1e]/80 border-b border-[#9D4EDD]/10">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <Link 
            href="/experience"
            className="flex items-center gap-2 text-[#9D4EDD] hover:text-white transition-colors text-sm font-medium"
      ...
      <main className="pt-24 pb-12 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="backdrop-blur-xl bg-[#0a0a1e]/70 border border-white/10 rounded-2xl p-4 group hover:border-[#9D4EDD]/30 transition-all duration-500">
              <div className="flex items-center justify-between mb-2">
          ...
          >
            <div className="lg:col-span-2">
              <div 
                ref={containerRef}
                className="relative w-full aspect-square lg:aspect-[4/3] rounded-3xl overflow-hidden border border-[#9D4EDD]/20 bg-[#050510]"
                style={{ boxShadow: '0 0 60px rgba(157, 78, 221,0.15), inset 0 0 60px rgba(157, 78, 221,0.05)' }}
              >
                {webglFailed ? (
                  <div className="w-full h-full flex items-center justify-center" data-testid="webgl-fallback">
                    <div className="text-center p-8">
                      <Globe2 className="w-24 h-24 mx-auto mb-4 text-[#9D4EDD]/50" />
                ...
                <div className="backdrop-blur-xl bg-[#0a0a1e]/70 border border-white/10 rounded-2xl p-4">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <button
                      ...
                      className={`p-1.5 rounded-lg transition-all ${showFilters ? 'bg-[#9D4EDD]/20 text-[#9D4EDD]' : 'text-white/50 hover:text-white'}`}
          ...
          >
              <div className="backdrop-blur-xl bg-gradient-to-r from-[#9D4EDD]/10 via-[#9D4EDD]/20 to-[#9D4EDD]/10 border border-[#9D4EDD]/20 rounded-3xl p-8 md:p-12 relative overflow-hidden">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#9D4EDD]/5 via-transparent to-transparent" />
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-center gap-4 mb-6">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[#9D4EDD]/70 text-sm">95% of breaches are preventable with proper security</p>
                    </div>
                  </div>
                  
                  <p className="text-white/60 max-w-2xl mx-auto mb-8 text-lg">
                    Our <span className="text-[#9D4EDD] font-semibold">Vulnerability Assessment & Penetration Testing (VAPT)</span> identifies 
                  ...
                  <div className="grid grid-cols-3 gap-6 mt-10 max-w-2xl mx-auto">
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#9D4EDD]">500+</div>
                      <p className="text-white/40 text-sm mt-1">Audits Completed</p>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#9D4EDD]">99.9%</div>
                      <p className="text-white/40 text-sm mt-1">Client Satisfaction</p>
                    </div>
                    <div className="text-center">
                      <div className="text-3xl font-bold text-[#9D4EDD]">24/7</div>
