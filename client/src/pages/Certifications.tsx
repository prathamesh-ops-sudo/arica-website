    ...
    return (
      ...
      >
        <div className="text-center">
          <div className="w-12 h-12 border-2 border-[#9D4EDD]/30 border-t-[#9D4EDD] rounded-full animate-spin mx-auto mb-4" />
...
function AnimatedCounter({ value, suffix = '' }: { value: number; suffix?: string }) {
  ...
  return (
    <div ref={ref} className="text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#9D4EDD] to-[#FFB800]">
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative pt-24 pb-16 overflow-hidden">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#9D4EDD] rounded-full blur-[150px]" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <Link href="/experience" className="inline-flex items-center gap-2 text-[#9D4EDD] hover:text-[#9D4EDD]/80 transition-colors mb-8" data-testid="link-back-experience">
            ...
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white">
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#9D4EDD] to-[#FFB800]">Certifications</span>
              </h1>
            </div>
          ...
          >
            <div className="relative bg-gradient-to-br from-slate-900/80 to-slate-800/50 rounded-3xl border border-slate-700/50 p-6 backdrop-blur-sm">
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-[#9D4EDD]/5 to-[#FFB800]/5" />
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="absolute top-1/2 left-0 right-0 h-1 bg-slate-700 -translate-y-1/2 hidden md:block overflow-hidden">
                <motion.div
                  className="h-full bg-gradient-to-r from-[#9D4EDD] via-[#FFB800] to-[#10B981]"
                  initial={{ width: 0 }}
                  animate={{ width: '83%' }}
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {trustStats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <Icon className="w-10 h-10 mx-auto mb-4 text-[#9D4EDD]" />
