...
export function HorizonHeroCss({ desktop = false }: { desktop?: boolean }) {
  return (
    <div className={desktop ? "horizon-hero-container horizon-hero-css-container" : undefined}>
      <section className={`relative flex min-h-[100svh] items-center justify-center overflow-hidden bg-background px-6 pb-14 pt-28 text-center${desktop ? " horizon-hero-css-section sticky top-0" : ""}`}>
      ...
      <div className="horizon-hero-css-content relative z-10 mx-auto flex max-w-xl flex-col items-center gap-5">
        <span className="mhero-chip rounded-full px-4 py-1.5 text-[0.7rem] font-medium uppercase tracking-[0.18em] text-slate-300">
          Cybersecurity Consultancy
        </span>

        <h1 className="horizon-hero-css-title horizon-hero-title text-halo-white text-[clamp(1.7rem,7.6vw,2.75rem)] leading-tight">
          ARICA TECH SECURITY
        </h1>
