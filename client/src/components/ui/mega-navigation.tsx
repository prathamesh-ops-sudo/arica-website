          ...
          <div className="grid grid-cols-1 gap-1">
            {links.map((link) => {
              ...
              return (
                ...
                >
                  <div className="flex-shrink-0 w-10 h-10 rounded-lg bg-gradient-to-br from-[#00D4FF]/20 to-[#9944ff]/20 flex items-center justify-center group-hover:from-[#00D4FF]/30 group-hover:to-[#9944ff]/30 group-hover:shadow-[0_0_15px_rgba(0,212,255,0.3)] transition-all duration-200">
          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            >
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <div className="absolute inset-0 bg-gradient-to-br from-[#00D4FF] to-[#9944ff] rounded-lg opacity-20 group-hover:opacity-40 transition-opacity" />
              ...
              <span className="hidden sm:block text-lg font-bold bg-gradient-to-r from-[#00D4FF] to-[#9944ff] bg-clip-text text-transparent">
                Arica Tech Security
              </span>
            </Link>
        ...
        {mobileOpen && (
          <>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-[#00D4FF]/50 via-[#9944ff]/50 to-[#00D4FF]/50" />
            </motion.div>
          </>
        )}
      </AnimatePresence>
