      ...
      >
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#00D4FF]/5 via-transparent to-[#9944ff]/5 pointer-events-none" />
            ...
            <div className="relative flex items-center justify-between px-6 py-3">
              <Link href="/" className="flex items-center gap-3 group">
                ...
                <div className="hidden sm:block">
                  <motion.span
                    className="text-lg font-bold bg-gradient-to-r from-[#00D4FF] to-[#9944ff] bg-clip-text text-transparent"
                    ...
                    >
                      {isActive && (
                        <motion.div
                          ...
                          className="absolute inset-0 bg-gradient-to-r from-[#00D4FF]/20 to-[#9944ff]/20 rounded-md border border-[#00D4FF]/40"
                          initial={false}
        ...
        {mobileOpen && (
          ...
          >
            ...
            >
                    ...
                    >
                      <motion.div
                        className={cn(
                          ...
                          isActive
                            ? "text-[#00D4FF] bg-gradient-to-r from-[#00D4FF]/20 to-[#9944ff]/10 border border-[#00D4FF]/40"
              ...
              <div className="h-1 bg-gradient-to-r from-[#00D4FF]/50 via-[#9944ff]/50 to-[#00D4FF]/50" />
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
