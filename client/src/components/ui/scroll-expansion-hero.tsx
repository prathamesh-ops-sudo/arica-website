            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              <div
                ...
                style={{
                  ...
                  maxWidth: "95vw",
                  maxHeight: "85vh",
                  boxShadow: "0px 0px 50px rgba(0, 212, 255, 0.2)",
                }}
              >
                {mediaType === "video" ? (
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  ...
                  {scrollToExpand && scrollProgress < 0.5 && (
                    <motion.p
                      className="text-muted-foreground font-medium text-center mt-2"
              ...
              >
                <motion.h2
                  className="text-5xl md:text-7xl lg:text-8xl font-bold text-halo-white transition-none font-display"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h2>
                <motion.h2
                  className="text-5xl md:text-7xl lg:text-8xl font-bold text-center text-halo-white transition-none font-display"
                  style={{ transform: `translateX(${textTranslateX}vw)` }}
                >
                  {restOfTitle}
                </motion.h2>
