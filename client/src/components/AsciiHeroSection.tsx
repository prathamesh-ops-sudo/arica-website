  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[#050505]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#0077B6]/10 rounded-full blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Endless
              <span className="block bg-gradient-to-r from-[#00B4D8] to-[#00D4FF] bg-clip-text text-transparent">
                Vigilance
              </span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Link href="/services">
                <Button className="bg-[#00B4D8] hover:bg-[#00B4D8]/90 text-white px-8 py-6 rounded-xl text-base group">
                  Begin Assessment
          ...
          >
            {features.map((feature, i) => (
              <motion.div
                ...
                className="group p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#00B4D8]/30 hover:bg-white/10 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#00B4D8]/20 to-[#00D4FF]/20 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    <feature.icon className="w-6 h-6 text-[#00B4D8]" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-1 group-hover:text-[#00B4D8] transition-colors">
                      {feature.title}
                    </h3>
            ...
            <div className="relative h-32 rounded-2xl overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-[#0077B6]/20 via-[#00D4FF]/20 to-[#0077B6]/20 animate-pulse" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-5xl font-bold bg-gradient-to-r from-[#00B4D8] to-[#00D4FF] bg-clip-text text-transparent">
                    ∞
                  </div>
