  ...
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden bg-[#121212]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#0a84ff]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#5e5ce6]/5 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-[#0a84ff]/10 border border-[#0a84ff]/20 flex items-center justify-center">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Endless
              <span className="block bg-gradient-to-r from-[#0a84ff] to-[#5e5ce6] bg-clip-text text-transparent">
                Vigilance
              </span>
            </h2>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Link href="/services">
                <Button className="bg-[#0a84ff] hover:bg-[#0a84ff]/90 text-white px-8 py-6 rounded-xl text-base group">
                  Begin Assessment
          ...
          >
            {features.map((feature, i) => (
              <motion.div
                ...
                className="group p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-[#0a84ff]/30 hover:bg-white/10 transition-all duration-300"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#0a84ff]/20 to-[#5e5ce6]/20 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
                    <feature.icon className="w-6 h-6 text-[#0a84ff]" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-1 group-hover:text-[#0a84ff] transition-colors">
                      {feature.title}
                    </h3>
            ...
            <div className="relative h-32 rounded-2xl overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-[#0a84ff]/20 via-[#5e5ce6]/20 to-[#0a84ff]/20 animate-pulse" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-5xl font-bold bg-gradient-to-r from-[#0a84ff] to-[#5e5ce6] bg-clip-text text-transparent">
                    ∞
                  </div>
